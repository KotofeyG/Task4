...
public class Letter implements TextComponent {
    ...
    public Letter(char symbol) throws TextException {
        if (String.valueOf(symbol).matches(NOT_A_LETTER_REGEX)) {
            throw new TextException("Incorrect argument: " + symbol);
        }
        this.symbol = symbol;
    }

    public Letter(String symbol) throws TextException {
        if (symbol == null || symbol.matches(NOT_A_LETTER_REGEX)) {
            throw new TextException("Incorrect argument: " + symbol);
        }
    ...
    public boolean equals(Object otherObject) {
        ...
        Letter other = (Letter) otherObject;
